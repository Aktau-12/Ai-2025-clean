...
# 🌍 Разрешённые источники (домен фронтенда и локальная разработка)
origins = [
    "https://ai-2025-clean-1.onrender.com",  # Фронтенд (Render)
...
app.add_middleware(
    ...
    allow_credentials=True,  # ВАЖНО для авторизации
    allow_methods=["*"],
    allow_headers=["*"],
)
